 ...
 */
final class Version20230701141427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paint ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paint DROP created_at, DROP updated_at');
