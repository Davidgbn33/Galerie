...
email:{empty:"Veuillez rensegner un email",incorrect:"Veuillez rensegner un email valide"},password:{empty:"Ton mot de passe est vide",incorrect:"Ton mot de passe est incorrect"},length:{empty:"Please, Enter a minimum of {0} characters and a maximum of {1}",incorrect:"Incorrect. Enter a minimum of {0} characters and a maximum of {1}"},minlength:{empty:"Please, enter at least {0} characters",incorrect:"Vous devez avoir au minimum {0} caractères"},maxlength:{empty:"Please, enter at maximum {0} characters",incorrect:"You have entered more than {0} characters"},maxfilesize:{empty:"The size of one or more selected files larger than {0} {1}",
